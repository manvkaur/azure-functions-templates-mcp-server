# Blob Output Binding - CSharp

This template demonstrates an Azure Function with a Blob output binding.
...
- [Identity-based connections for Blob Storage](https://learn.microsoft.com/azure/azure-functions/functions-bindings-storage-blob-trigger?pivots=programming-language-csharp&tabs=in-process%2Cextensionv5#identity-based-connections)
