...
- [Identity-based connections for Queue Storage](https://learn.microsoft.com/azure/azure-functions/functions-bindings-storage-queue-trigger?pivots=programming-language-python&tabs=python-v2%2Cextensionv5#identity-based-connections)
