...
This template demonstrates an Azure Function with enhanced blob trigger using Azure Event Grid for better performance and preferred.
...
1. Run `func start` to start the function locally
